...
void manage_equipment(perso_t * player){
	...
	do {
		printf("1. Remove an item from your equipment\n");
		printf("2. Equip an item from your inventory\n");
	...
	if(choise != -1){
		switch(choise){
			case 1: remove_equipment_player(player); goto jump; break;
			case 2: equip_player(player); goto jump; break;
			default: break;
		}
	}
}
